...
function task_multiSelect(lesson, ind, task){
    //data
    var self = this;
    self.lesson =lesson;
    self.index = ind;
    ...
    self.taskPanelOpen = function(){
        ...
        flyOutChoices.append("<p class='flyOutChoice' ><input type='checkbox' name='selectChoices' data-bind='"+radioDataBind+"'/><label data-bind='"+labelDataBind+"'/></p>");
        container.append("<!-- /ko -->");
