lesson_data={
	...
	[
		...
		},
		{
			"Reference":"Topic",
			"Type":"Container",
			"Title":"What is the topic for your essay?",
			"Tasks":
			[
				{
					"Reference":"Topic1",
				...
				},
				{
					...
					"Type":"ListSelection",
					"Title":"Sample Topics",
					"Instruction":"<p>You can choose a topic from this list if you can't think of a topic on your own",
					"Choices":[
						"Topic1",
						"Topic2",
						"Topic3",
		...
		},
		{
			...
			"Instruction":"Check that your essay is complete and that it is ready to submit. You should double-check your spelling, correct use of sentences and paragraphs, and punctuation. Refer to the reference section if you need help with any of these",
